...
Elle vous garantit le remboursement à 100% de votre inscription jusqu’au SAMEDI minuit (J-8) sans aucun justificatif puis 50% jusqu’au JEUDI MINUIT (J-4) précédant l’événement.`
  ...
  return (
    ...
    <div>
      <h2 className='pl-8 pt-20 text-2xl text-center sm:text-left'><span className='yellow'>INFOS</span> GENERALES</h2>
      ...
      <h2 className='pl-8 pt-10 text-2xl text-center sm:text-left'><span className='yellow'>INFOS</span> PRATIQUES</h2>
