...
function Arguments() {
  ...
  const argumentsContent = [
    ...
    // {title1: 'UN SAVOIR', title2: 'FAIRE', content: 'En 2010, La FRAPPADINGUE est née. Pour une première fois sur un même terrain de jeux, des sportifs (et non sportifs) de tous horizons se retrouveront.\n\nLa course à obstacles à la française est lancée alliant épreuve sportive et ambiance festive.\n\nDES OBSTACLES / DES DÉFIS / DES POTES / DU FUN.'},
  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 justify-center items-center pb-40 sm:m-0 pr-8 pl-8'>
