  ...
  return (
    <div className='flex flex-row flex-wrap justify-center items-center pr-8 pl-8'>
      ...
      <div className='w-full sm:basis-2/3'>
        ...
        <br />
        <p className='font-light text-md'>La FRAPPADINGUE c’est une course à obstacles hors du commun: un parcours parsemé d’embûches, de passages d’échelles, de ponts de singe, de filets à grimper, de tunnels à franchir, de boue et bien plus encore…
        <br /><br />
